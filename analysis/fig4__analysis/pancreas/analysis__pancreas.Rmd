---
title: "Deatiled analysis of gene panels for pancreas."
...
sce$celltype[which(sce$celltype %in% c("macrophage" , "mast"))] = "immune"
...
p
ggsave(filename = paste0(figures.dir, "umap_CTs" ,".png"), plot = p, width = 5, height = 5)
...
p
ggsave(filename = paste0(figures.dir, "CT_composition" ,".png"), plot = p, width = 6, height = 3)
