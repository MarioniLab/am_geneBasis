---
title: "Pipeline to assess how addtionally selected genes improve cell type mapping (pancreas)."
output:
...
sce$celltype[which(sce$celltype == "macrophage")]   = "immune"
sce$celltype[which(sce$celltype == "mast")]   = "immune"
...
mappings$celltype[which(mappings$celltype %in% c("macrophage" , "mast"))] = "immune"
mappings$mapped_celltype[which(mappings$mapped_celltype %in% c("macrophage" , "mast"))] = "immune"
