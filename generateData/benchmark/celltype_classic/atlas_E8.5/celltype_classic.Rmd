...
genes = lapply(1:length(genes_scmer_batched) , function(i){
  ...
  out = list("alsu" = as.character(genes_alsu[1:n_genes]) , "scmer_batched" = as.character(current.genes_scmer))
  return(out)
})
...
genes = lapply(1:length(genes_scmer_unbatched) , function(i){
  ...
  n_genes = length(current.genes_scmer)
  out = list("alsu" = as.character(genes_alsu[1:n_genes]) , "scmer_unbatched" = as.character(current.genes_scmer))
  return(out)
})
