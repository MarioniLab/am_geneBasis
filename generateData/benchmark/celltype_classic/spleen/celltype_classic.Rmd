...
stat_scmer_batched = rbind(stat_scmer_batched.all , stat_scmer_batched.markers)
stat_scmer_batched$type = factor(stat_scmer_batched$type, levels = c("geneBasis" , "SCMER" , "hvgs"))
saveRDS(stat_scmer_batched , file = paste0(root.dir , "data/benchmark/celltype_classic/" , system , "/celltype_classic__scmer_batched_updated.Rds"))
...
stat_scmer_unbatched = rbind(stat_scmer_unbatched.all , stat_scmer_unbatched.markers)
stat_scmer_unbatched$type = factor(stat_scmer_unbatched$type, levels = c("geneBasis" , "SCMER" , "hvgs"))
saveRDS(stat_scmer_unbatched , file = paste0(root.dir , "data/benchmark/celltype_classic/" , system , "/celltype_classic__scmer_unbatched_updated.Rds"))
...
stat_scgenefit$type = factor(stat_scgenefit$type, levels = c("geneBasis" , "SCMER" , "hvgs"))
