...
genes = lapply(1:length(genes_scmer_unbatched) , function(i){
  ...
  n_genes = length(current.genes_scmer)
  out = list("geneBasis" = as.character(genes_alsu[1:n_genes]) , "scmer_batched" = as.character(current.genes_scmer), "hvgs" = as.character(get_hvgs(sce , n_genes)) )
  return(out)
})
