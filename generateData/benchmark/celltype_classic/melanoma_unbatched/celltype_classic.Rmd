...
get_celltypes_stat_single_id = function(sce , genes , batch = NULL, n.neigh = 5, option = "all"){
  if (option == "markers"){
...
get_celltypes_stat = function(genes , option){
  celltype_stat = bplapply(c(1:length(genes)) , function(i){
    ...
    stat.per_n_genes = lapply(1:length(current.genes) , function(j){
      current.stat = suppressWarnings( get_celltypes_stat_single_id(sce , genes = current.genes[[j]] , batch = NULL ,n.neigh = 5 , option = option) )
...
saveRDS(stat_scmer_batched , file = paste0(root.dir , "data/benchmark/celltype_classic/" , system , "_unbatched/celltype_classic__scmer_batched.Rds"))
...
saveRDS(stat_scmer_unbatched , file = paste0(root.dir , "data/benchmark/celltype_classic/" , system , "_unbatched/celltype_classic__scmer_unbatched.Rds"))
...
saveRDS(stat_scgenefit , file = paste0(root.dir , "data/benchmark/celltype_classic/" , system , "_unbatched/celltype_classic__scgenefit.Rds"))
