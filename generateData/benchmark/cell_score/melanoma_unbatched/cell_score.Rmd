...
neighs.all = get_z_scaled_distances(sce , genes.all = hvgs_10000 , batch = NULL, n.neigh = 5 , nPC.all = 50)
  ...
  cell_score_stat = bplapply(c(1:length(genes)) , function(i){
    ...
    stat.per_n_genes = lapply(1:length(current.genes) , function(j){
      current.stat = suppressWarnings( get_preservation_score(sce , neighs.all = neighs.all ,  genes.all = hvgs_10000, 
                                                 genes.compare = current.genes[[j]], batch = NULL ,n.neigh = 5 , nPC.all = 50 , nPC.compare = nPC) )
...
saveRDS(stat_scmer_batched , file = paste0(root.dir , "data/benchmark/cell_score/" , system , "_unbatched/cell_score__scmer_batched.Rds"))
...
saveRDS(stat_scmer_unbatched , file = paste0(root.dir , "data/benchmark/cell_score/" , system , "_unbatched/cell_score__scmer_unbatched.Rds"))
...
saveRDS(stat_scgenefit , file = paste0(root.dir , "data/benchmark/cell_score/" , system , "_unbatched/cell_score__scgenefit.Rds"))
