...
types = c("t_unscaled_unweighted" , "t_unscaled_weighted" , "t_pairwise_centers" , "t_all" , 
          "binom_unscaled_unweighted" , "binom_unscaled_weighted" , "binom_pairwise_centers" , "binom_all" )
...
genes = list(markers.t , markers.t , markers.t , markers.t , markers.binom , markers.binom , markers.binom , markers.binom )
stats = lapply(1:length(mappings) , function(i){
  stat = getCorrTranscriptome(mappings[[i]] , genes[[i]])
