...
genes_all = as.character(genes_all$gene[1:150])
...
get_celltypes_stat = function(sce , genes , batch = "sample", n.neigh = 5){
  ...
  neighs = suppressWarnings( get_mapping(sce , genes = genes, batch = batch, n.neigh = n.neigh, nPC = 50 , get.dist = F , type = "together"))
  if (!is.null(neighs)){
...
stat_celltype = lapply(n_genes.grid , function(n_genes){
  stat.per_n_genes = bplapply(1:length(genes) , function(i){
...
saveRDS(stat_celltype , file = paste0(root.dir , "data/spleen_by_sample_stat" , "/celltype_classic.Rds"))
...
saveRDS(cell_score_stat , file = paste0(root.dir , "data/spleen_by_sample_stat"  , "/cell_score.Rds"))
...
saveRDS(cell_score_stat , file = paste0(root.dir , "data/spleen_by_sample_stat"  , "/gene_score.Rds"))
