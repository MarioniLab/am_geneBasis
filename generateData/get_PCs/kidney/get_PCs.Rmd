...
save.dir = paste0(root.dir , "data/PCs/kidney/")
...
reference.bool = sapply(1:ncol(sce), function(i){
  if (sce$sample[i] == "Experiment set 1"){
    return(T)
  } else {
    return(F)
  }
...
genes.4seq = get_suitable4seq_genes(dir = "cluster", system = "kidney" , mean.thresh = 7, max.thresh = 350)
