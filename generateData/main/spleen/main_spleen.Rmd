---
title: "Generate bits for spleen."
output:
...
markers = readRDS(paste0(save.dir, "markers_t.Rds"))
...
#saveRDS(loadings , file = paste0(save.dir, "loadings_t.Rds"))
loadings = readRDS(paste0(save.dir, "loadings_t.Rds"))

#gene.stat = rank_genes(loadings)  
#saveRDS(gene.stat , file = paste0(save.dir, "gene_ranking_t.Rds"))
gene.stat = readRDS(paste0(save.dir, "gene_ranking_t.Rds"))
...
saveRDS(mappings , file = paste0(save.dir, "mappings_t.Rds"))
