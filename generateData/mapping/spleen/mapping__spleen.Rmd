...
genes_unweighted_scaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/spleen/" , "genes_unweighted_scaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_weighted_scaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/spleen/" , "genes_weighted_scaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_unweighted_unscaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/spleen/" , "genes_unweighted_unscaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_weighted_unscaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/spleen/" , "genes_weighted_unscaled__totalScore" , ".tab"), header = T , sep = "\t")
