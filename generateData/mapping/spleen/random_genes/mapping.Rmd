...
# load markers
markers = read.table(paste0(root.dir , "data/markers/" , system , "/markers__binom.tab") , header = T, sep = "\t")
markers = unique(markers$gene)
markers = intersect(markers , genes.4seq)

nPC.grid = seq(10,180,10) 
K = 5
mappings.all = lapply(1:K , function(i){
  ...
  saveRDS(mappings , file = paste0(save.dir, "binom_rand_" , i, ".Rds"))
})
...
# load markers
markers = read.table(paste0(root.dir , "data/markers/" , system , "/markers__t.tab") , header = T, sep = "\t")
markers = unique(markers$gene)
markers = intersect(markers , genes.4seq)
...
mappings.all = lapply(1:K , function(i){
  ...
  names(mappings) = paste0("nGenes_" , nPC.grid)
  saveRDS(mappings , file = paste0(save.dir, "t_rand_" , i, ".Rds"))
})
