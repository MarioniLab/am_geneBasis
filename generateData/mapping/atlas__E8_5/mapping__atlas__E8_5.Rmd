...
# read gene selection
genes_unweighted_scaled__oneRound = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_scaled__oneRound" , ".tab"), header = T , sep = "\t")

genes_weighted_scaled__oneRound = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_scaled__oneRound" , ".tab"), header = T , sep = "\t")

genes_unweighted_unscaled__oneRound = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_unscaled__oneRound" , ".tab"), header = T , sep = "\t")

genes_weighted_unscaled__oneRound = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_unscaled__oneRound" , ".tab"), header = T , sep = "\t")



genes_unweighted_scaled__twoRounds = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_scaled__twoRounds" , ".tab"), header = T , sep = "\t")

genes_weighted_scaled__twoRounds = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_scaled__twoRounds" , ".tab"), header = T , sep = "\t")

genes_unweighted_unscaled__twoRounds = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_unscaled__twoRounds" , ".tab"), header = T , sep = "\t")

genes_weighted_unscaled__twoRounds = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_unscaled__twoRounds" , ".tab"), header = T , sep = "\t")



genes_unweighted_scaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_scaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_weighted_scaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_scaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_unweighted_unscaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_unweighted_unscaled__totalScore" , ".tab"), header = T , sep = "\t")

genes_weighted_unscaled__totalScore = read.table(paste0(root.dir , "data/gene_selection/atlas__E8_5/" , "genes_weighted_unscaled__totalScore" , ".tab"), header = T , sep = "\t")
...
# saveRDS(mapping.all , file = paste0(root.dir, "data/mappings/atlas__E8_5/all_markers.Rds"))
#   
# 
...
getMapping = function(genes, n.neigh = 10){
  ...
  reference.cells = colnames(current.sce[,current.sce$reference == T]) 
  query.cells = colnames(current.sce[, current.sce$reference == F]) 
  current.knns = queryKNN( joint.pca[reference.cells ,], joint.pca[query.cells ,], k = n.neigh, 
                           get.index = TRUE, get.distance = FALSE)
  cells.mapped = t( apply(current.knns$index, 1, function(x) reference.cells[x]) )
  celltypes = t(apply(cells.mapped, 1, function(x) meta$celltype[match(x, meta$cell)]))
  celltype.mapped = apply(celltypes, 1, function(x) getmode(x, 1:length(x)))
...
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_scaled__oneRound.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_unscaled__oneRound.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_scaled__oneRound.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_unscaled__oneRound.Rds"))
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_scaled__twoRounds.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_unscaled__twoRounds.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_scaled__twoRounds.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_unscaled__twoRounds.Rds"))
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_scaled__totalScore.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/weighted_unscaled__totalScore.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_scaled__totalScore.Rds"))
#
mappings = lapply(nPC.grid , function(i){
...
names(mappings) = paste0("nGenes_" , nPC.grid)
saveRDS(mappings , file = paste0(root.dir, "data/mappings/atlas__E8_5/unweighted_unscaled__totalScore.Rds"))
...
saveRDS(mappings.bianca.centers , file = paste0(root.dir, "data/mappings/atlas__E8_5/bianca__centers.Rds"))
...
saveRDS(mappings.bianca.pairwise , file = paste0(root.dir, "data/mappings/atlas__E8_5/bianca__pairwise.Rds"))
...
saveRDS(mappings.bianca.pairwise_centers , file = paste0(root.dir, "data/mappings/atlas__E8_5/bianca__pairwise_centers.Rds"))
