...
save.dir = paste0(root.dir, "data/mappings/atlas_E8.5/")
...
current.genes = read.table(paste0(root.dir , "data/gene_ranking/atlas_E8.5/binom_RF.tab") , header = T , sep = "\t")
...
current.genes = read.table(paste0(root.dir , "data/gene_ranking/atlas_E8.5/t_RF.tab") , header = T , sep = "\t")
current.genes = unique(current.genes$gene)
mappings = get_mapping(current.genes , sce)
