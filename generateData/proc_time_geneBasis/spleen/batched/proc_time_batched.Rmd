...
# 
# proc_time_add_genes = function(sce , stat = NULL, genes_base = NULL, assay = "logcounts", n_genes_total = 150, batch , p = 3){
#   t0 = proc.time()
#   if (is.null(stat)){
...
# 
# saveRDS(stat , file = paste0(root.dir , "data/processed_time/geneBasis/" , system , "/stat_unparalleled_batched.Rds"))
# 
# 
...
saveRDS(stat , file = paste0(root.dir , "data/processed_time/geneBasis/" , system , "/stat_unparalleled_batched_updated.Rds"))
