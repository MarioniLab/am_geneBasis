...
batch = "dataset"
sce = readRDS( paste0( root.dir , "data/scRNA_datasets/pbmc/pbmc.rds"))
if (!"logcounts" %in% names(assays(sce))){
  sce = add_logcounts(sce , batch)
  saveRDS(sce , file = paste0( root.dir , "data/scRNA_datasets/pbmc/pbmc.rds") )
}
...
sce_denoised = SingleCellExperiment(list(counts=counts(sce) , 
                           ...
                           colData = colData(sce) )
saveRDS(sce_denoised , file = paste0(root.dir , "data/scRNA_datasets/pbmc/pbmc__denoised.Rds"))
...
saveRDS(out , file = paste0(root.dir , "data/gene_basis/pbmc/pbmc__minCorr_selection.Rds"))
...
min_corr_stat = rbind(data.frame(n_genes = 1:3 , min_corr = c(0,0,0) , gene = genes_all[1:3]) , min_corr_stat)
out = list(genes = genes_all , min_corr_stat = min_corr_stat)
saveRDS(out , file = paste0(root.dir , "data/gene_basis/pbmc/pbmc__maxLoading_selection.Rds"))
