...
saveRDS(corr_stat_all , file = paste0(root.dir , "data/scRNA_datasets/" , system , "/corr_stat_all.Rds"))
...
saveRDS(out , file = paste0(root.dir , "data/gene_basis/" , system  , "/" , system , "__minCorr_selection.Rds"))
...
min_corr_stat = rbind(data.frame(n_genes = 1:3 , min_corr = c(0,0,0) , gene = genes_all[1:3]) , min_corr_stat)
out = list(genes = genes_all , min_corr_stat = min_corr_stat)
saveRDS(out , file = paste0(root.dir , "data/gene_basis/" , system  , "/" , system , "__maxLoading_selection.Rds"))
