...
#     counts = data.frame(cell = colnames(sce) , counts = as.numeric(assay(sce , "logcounts.denoised")[gene , ]))
...
#     return(p)
#   })
#   p <- ggarrange(plotlist = plots , ncol = 5, nrow = 5)
#   return(p)
# }
# 
...
#     }
#     ggsave(filename = paste0(figures.dir , "umaps/" , gene_selections.anno$descr[i] , "_" , gene_selections.anno$run[i] , "/", n_genes , ".png"), plot = p, width = 10, height = 10)
#     return(NA)
#   })
#   return(NA)
# })
...
plots = lapply(vars , function(var){
  ...
  print(p)
  #ggsave(filename = paste0(figures.dir, "general_stat/" , var ,".png"), plot = p, width = 8, height = 5)
  return(p)
})
...
p = ggplot(stat_mapping_celltypes , aes(x = factor(n_genes) , y = frac_correctly_mapped , fill = descr)) + 
  ...
  theme_classic()
p
#ggsave(filename = paste0(figures.dir, "celltype_mapping_overall.png"), plot = p, width = 17, height = 6)
