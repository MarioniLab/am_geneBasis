...
stat_gene_score_all = suppressWarnings( get_corr_per_gene(sce, genes = hvgs_5000, batch = "sample" , n.neigh = 5 , nPC = 50 , genes.predict = hvgs_5000 , type = "corr") ) 
