...
stat_gene_score_all = suppressWarnings( get_corr_per_gene(sce, genes = hvgs_5000, batch = "sample" , n.neigh = 5 , nPC = 50 , genes.predict = hvgs_5000 ) ) 
...
stat_gene_score = bplapply(n_genes.grid , function(n_genes){
  stat.per_n_genes = lapply(1:length(genes) , function(i){
    ...
    current.stat = suppressWarnings( get_corr_per_gene(sce , current.genes[1:n_genes] , batch = "sample", n.neigh = 5 , nPC= 50 , genes.predict = hvgs_5000 , type = "corr" ) )
    current.stat$n_genes = n_genes
