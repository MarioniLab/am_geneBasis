...
tomato.grid = c(T,F)
genes_stat = bplapply(tomato.grid, function(tomato){
  genes = add_genes(sce[, sce$tomato == tomato] , stat = NULL, genes_base = NULL, assay = "logcounts", n_genes_total = n_genes, batch = NULL, p = p)
