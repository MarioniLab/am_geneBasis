...
genes_stat = lapply(c(1:K) , function(i){
  genes = add_genes(sce , stat = NULL, genes_base = NULL, assay = "logcounts", n_genes_total = n_genes, batch = NULL, p = p)
  saveRDS(genes , paste0(root.dir , "data/gene_selection/" , system , "/" , "gene_selection_unbatched_" , i, ".Rds"))
  return(genes)
})
