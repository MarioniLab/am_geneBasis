...
sce = readRDS(paste0("/Users//alsu/Develop/External/Zeisel_mouseBrain/" , "olfactory", ".Rds"))
...
seqfish_olfactory = readRDS("/Users/alsu/Develop/External/seqFISH_plus/seqfish_olfactory.Rds")
sce = sce[rownames(sce) %in% rownames(seqfish_olfactory) , ]
