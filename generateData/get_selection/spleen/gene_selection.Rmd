...
genes_stat = bplapply(c(1:nrow(pars)) , function(i){
  ...
  genes = add_genes(sce , stat = NULL, genes_base = genes_base, assay = pars$assay[i], n_genes_total = n_genes_total, batch = "sample", type = pars$type[i], ratio.type = pars$ratio.type[i])
