...
genes.denoised = add_genes(sce, genes_base = genes_base, assay = "cosine.logcounts.denoised", n_genes_total = 5, batch = "sample", type = "denoised")
genes.raw = add_genes(sce, genes_base = genes_base, assay = "cosine.logcounts", n_genes_total = 5, batch = "sample", type = "raw")
out = list(denoised = genes.denoised , raw = genes.raw)
#return(out)


saveRDS(out , paste0(root.dir , "data/gene_selection/" , system , "/gene_selection_" , system , ".Rds"))
