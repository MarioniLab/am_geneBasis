...
genes_stat = lapply(nPC.grid , function(nPC){
  genes_base = gene_selection$gene[gene_selection$rank <= nPC + 1]
  genes = gene_search(sce , genes_base = NULL, n_genes_total = n_genes_total, batch = "sample", n.neigh = 5, p = 3, K = 5, nPC = nPC, ncores = ncores)
