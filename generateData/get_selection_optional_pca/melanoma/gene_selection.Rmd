...
gene_selection = readRDS(paste0(root.dir , "data/gene_selection/" , system , "/gene_selection_unbatched.Rds"))
genes_stat = bplapply(nPC.grid , function(nPC){
  genes_base = as.character(gene_selection$gene[gene_selection$rank <= nPC + 1])
  genes = gene_search(sce , genes_base = genes_base, n_genes_total = n_genes_total, batch = NULL, n.neigh = 5, p = 3, K = 5, nPC = nPC)
